        ...
        <div class="pl-2 w-full bg-white dark:bg-gray-900/90">
          ...
          <Show when={!isMac()} fallback={<div class="h-8"></div>}>
            <div class="flex h-10 justify-end flex-0">
              <button class="w-10 h-10 text-xl hover:bg-[#E9E9E9] dark:hover:bg-[#2D2D2D] hover:text-gray-500" onclick={() => WindowMinimise()}><Icon icon="mdi:window-minimize" /></button>
              <button class="w-10 h-10 text-xl hover:bg-[#E9E9E9] dark:hover:bg-[#2D2D2D] hover:text-gray-500" onclick={() => isMaxWindow() ? WindowUnmaximise() : setIsMaxWindow(!isMaxWindow()) && WindowMaximise()}><Icon icon="mdi:window-maximize" /></button>
              <button class="w-10 h-10 text-xl hover:bg-[#C13124] dark:hover:bg-[#C13124] hover:text-white" onclick={() => Quit()}><Icon icon="mdi:window-close" /></button>
            </div>
          </Show>
